...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "borrowAccountParagraph" : MessageLookupByLibrary.simpleMessage("要购买一个帐户，首先你需要免费借用一个。如果您在<colored>%3天<colored>内至少存入<colored>%1 Pascal (%2)<colored>到该账号，该账号将是您的，并且<colored>%1 Pascal<colored>将自动从您的余额中扣除。\n否则，它将在<colored>%3天<colored>结束时返回给我们，不再属于您的钱包。\n建议您在完全拥有该帐号前只存入少量的Pascal。"),
    ...
    "borrowedAccountParagraph" : MessageLookupByLibrary.simpleMessage("这是一个<colored>借用的账号</colored>。\n如果您在接下来的<colored>%2 天， %3 时，%4 分</colored>内存入<colored>%1 Pascal</colored>到该账号中，您将永远拥有它。"),
    "borrowedHeader" : MessageLookupByLibrary.simpleMessage("借用"),
    ...
    "getAccountSecondParagraph" : MessageLookupByLibrary.simpleMessage("\n 1- 通过手机号码获得账号， <colored>每个手机号码只能获得一个.</colored>"),
    "getAccountSheetHeader" : MessageLookupByLibrary.simpleMessage("获取一个账号"),
    "getAccountThirdParagraph" : MessageLookupByLibrary.simpleMessage("2-  您可以使用<colored>%1 Pascal (%2).</colored>购买任意数量的账号。"),
    ...
    "logoutFirstDisclaimerParagraph" : MessageLookupByLibrary.simpleMessage("<colored?登出将会从这个设备删除您的私钥和所有与Blaise钱包相关的数据。</colored>如果您的私钥还未备份，您将永远无法访问您的资金。如果您的私钥已备份，则无需担心。"),
    "logoutHeader" : MessageLookupByLibrary.simpleMessage("登出"),
    "logoutSecondDisclaimerParagraph" : MessageLookupByLibrary.simpleMessage("您确定备份了您的私钥吗?<colored>只要你备份了你的私钥，你就没有什么好担心的.</colored>"),
    "looksLikeEncryptedKeyParagraph" : MessageLookupByLibrary.simpleMessage("这看起来像是一个加密过的私钥，请输入密码以解密并导入它。"),
    ...
    "newNameOPDetails" : MessageLookupByLibrary.simpleMessage("新的名字"),
    ...
    "noHeader" : MessageLookupByLibrary.simpleMessage("否认"),
    ...
    "yesHeader" : MessageLookupByLibrary.simpleMessage("确认"),
