...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "addressTextFieldHeader" : MessageLookupByLibrary.simpleMessage("Adresse"),
    ...
    "backUpKeyHeader" : MessageLookupByLibrary.simpleMessage("Sichere deinen Schlüssel"),
    ...
    "backupKeyFourthParagraph" : MessageLookupByLibrary.simpleMessage("Wir empfehlen dir die dechiffrierte Version des Schlüssels auf einem Blatt Papier zu notieren. Die chiffrierte Version kann in einem Passwort Manager gespeichert werden."),
    ...
    "backupUnencryptedKeyParagraph" : MessageLookupByLibrary.simpleMessage("Nachfolgend siehst du deinen privaten Schlüssel. <colored>Dieser ist nicht mit einem Passwort geschützt, deshalb ist es zwingend erforderlich, dass du ihn sicher offline verwahrst!</colored> Wir empfehlen dir ihn auf Papier zu notieren."),
    ...
    "borrowAccountParagraph" : MessageLookupByLibrary.simpleMessage("Um ein Konto zu kaufen, musst du dir zu Beginn eines ausleihen. Wenn du innerhalb von <colored>%3 Tage(n)</colored> <colored>%1 Pascal (%2)</colored> an das Konto überweist, gehört es dir und der Betrag von <colored>%1 Pascal</colored> wird automatisch abgezogen.\nAnsonsten geht das geliehene Konto nach <colored>%3 Tage(n)</colored> an uns zurück und ist nicht mehr Teil deiner Wallet.\nWir empfehlen dir nicht zu große Beträge an das Konto zu senden, solange es nicht Dir gehört."),
    ...
    "checkOutBlaiseParagraph" : MessageLookupByLibrary.simpleMessage("Schau dir Blaise an! Sichere und einfach zu bedienende Pascal Wallet für iOS und Android: https://blaisewallet.com"),
    ...
    "copiedAddressButton" : MessageLookupByLibrary.simpleMessage("Adresse kopiert"),
    "copiedButton" : MessageLookupByLibrary.simpleMessage("Kopiert"),
    "copyAddressButton" : MessageLookupByLibrary.simpleMessage("Adresse kopieren"),
    ...
    "invalidAddressError" : MessageLookupByLibrary.simpleMessage("Ungültige Adresse"),
    ...
    "newPrivateKeyParagraph" : MessageLookupByLibrary.simpleMessage("Nachfolgend findest du deinen neuen privaten Schlüssel. Es ist unbedingt erforderlich, dass du diesen sicherst - aber bitte nicht als Screenshot oder in Klartext. Wir empfehlen Dir ihn auf einem Blatt Papier zu notieren."),
    ...
    "receivingAccountOPDetails" : MessageLookupByLibrary.simpleMessage("Empfange Konto"),
    ...
    "sendingAccountOPDetails" : MessageLookupByLibrary.simpleMessage("Übertrage Konto"),
    ...
    "setToDefaultButton" : MessageLookupByLibrary.simpleMessage("Als Standard festlegen"),
    ...
    "totalBalanceHeader" : MessageLookupByLibrary.simpleMessage("Summe"),
    ...
    "welcomeParagraph" : MessageLookupByLibrary.simpleMessage("Willkommen bei der Blaise Wallet. Um zu starten kannst du entweder einen neuen privaten Schlüssel generieren oder einen Bestehenden importieren."),
